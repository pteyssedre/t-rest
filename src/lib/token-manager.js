...
var crypto_helper_1 = require("./crypto-helper");
var teys_injector_1 = require("teys-injector");
var moment = require("moment");
var TokenManager = /** @class */ (function () {
    function TokenManager() {
    }
    TokenManager.prototype.createAuthenticationToken = function (userId, roles) {
    ...
    TokenManager.prototype.readJwt = function (tokenValue) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
    ...
    TokenManager.prototype.tokenStatus = function (claims, roles) {
    ...
    ], TokenManager.prototype, "crypto", void 0);
    __decorate([
        teys_injector_1.Inject("token-domain"),
        __metadata("design:type", String)
    ], TokenManager.prototype, "domain", void 0);
    __decorate([
        teys_injector_1.Inject("token-duration"),
        __metadata("design:type", String)
    ], TokenManager.prototype, "duration", void 0);
